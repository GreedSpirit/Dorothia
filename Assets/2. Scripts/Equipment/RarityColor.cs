...
{
    private Color _normalColor = new Color32(188,188,188,255);
    private Color _uncommonColor = new Color32(0,181,0,255);
    private Color _rareColor = new Color32(39,107,188,255);
    private Color _legendaryColor = new Color32(255,104,0,255);
    private Color _mythicColor = new Color32(255,0,0,255);
