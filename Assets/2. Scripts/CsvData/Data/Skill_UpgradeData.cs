...
public class Skill_UpgradeData : ICSVLoad, ITableKey
{
    ...
    public float Skill_Upgrade_Multiplier { get; set; }
    ...
    public void LoadFromCsv(string[] values)
    {
        ...
        // 1: Skill_Upgrade_Multiplier (float)
        if (values.Length > 1 && float.TryParse(values[1], out float v1)) Skill_Upgrade_Multiplier = v1;
    }
}
