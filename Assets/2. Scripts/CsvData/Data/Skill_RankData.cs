...
public class Skill_RankData : ICSVLoad, ITableKey
{
    ...
    public float Skill_Rank_Multiplier { get; set; }
    ...
    public void LoadFromCsv(string[] values)
    {
        ...
        // 1: Skill_Rank_Multiplier (float)
        if (values.Length > 1 && float.TryParse(values[1], out float v1)) Skill_Rank_Multiplier = v1;
