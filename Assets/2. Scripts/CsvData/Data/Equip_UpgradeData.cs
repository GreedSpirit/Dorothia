...
public class Equip_UpgradeData : ICSVLoad, ITableKey
{
    ...
    public Equip_Upgrade_Section Equip_Upgrade_Section { get; set; }
    ...
    public void LoadFromCsv(string[] values)
    {
        ...
        // 1: Equip_Upgrade_section (Equip_Upgrade_Section)
        if (values.Length > 1 && Enum.TryParse(values[1], out Equip_Upgrade_Section v1)) Equip_Upgrade_Section = v1;
